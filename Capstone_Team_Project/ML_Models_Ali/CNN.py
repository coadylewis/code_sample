...
def CNN(filedir: str, training_filename: str, testing_file: str=None, seq_len: int=5):
    ...
    model = keras.Sequential([
        keras.layers.Conv1D(filters=64, kernel_size=2, activation='relu', input_shape=input_shape),
...
if __name__ == "__main__":
    ...
    try:
        CNN(filedir, "PS_w1280a1280.csv", seq_len=12, testing_file="../data/combined/raw/storage/processed/PS_w1280a1280.csv")
